...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { cloud: @point.cloud, high: @point.high, low: @point.low, rain: @point.rain, run_id: @point.run_id, time: @point.time }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { cloud: @point.cloud, high: @point.high, low: @point.low, rain: @point.rain, run_id: @point.run_id, time: @point.time }
    assert_redirected_to point_path(assigns(:point))
  end
